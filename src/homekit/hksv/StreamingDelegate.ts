...
export class streamingDelegate implements CameraStreamingDelegate, FfmpegStreamingDelegate {
  ...
  private async startStream(request: StartStreamRequest, callback: StreamRequestCallback) {
    ...
    const ffmpegArgs: string[] = [
      ...
      // Lense distortion correction // experimental
      //'-vf', 'v360=input=sg:ih_fov=97:iv_fov=75:output=flat:d_fov=120:w=2400:h=1400,crop=1820:1240,scale=1280:720,setsar=1',
      '-b:v', '299k',
      '-payload_type', '99',
